...
// Updated useSidebar to use Zustand store
function useSidebar() {
  return useZustandSidebar()
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:group-data-[collapsible=offcanvas]:bg-sidebar hover:bg-sidebar/20 group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full",
